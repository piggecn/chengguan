...
- **巡查记录**：选乡镇 → 选小区（自动补全）→ 点选问题分类（12 类：牛皮癣小广告、乱堆放杂物、电动车乱停放、流动摊贩、出店经营、毁坏绿化等）→ 写描述 → 拍照上传（可多张、原图保留）；待处理 → 整改销号，现场照与整改照前后对比留痕
...
- **数据统计**：按乡镇 / 问题分类 / 小区排行 / 案件汇总，支持选起止日期，并可切换时间口径 —— 智能（默认，已结案按结案时间、未结案按录入时间）、按录入时间、按结案时间；每项都能点进去看明细
